...
if __name__ == "__main__":
    ...
    try:
        ...
        rx=np.array(list(range(0,shapeDict['size'][0])),dtype=float)-shapeDict['xc'][0]
        ry=np.array(list(range(0,shapeDict['size'][1])),dtype=float)-shapeDict['xc'][1]
