...
if __name__ == '__main__':
    ...
    if opts.polar:
        ...
        plt.xticks(np.arange(0,len(rx)*nmax,len(rx))+(len(rx)/2),list(range(nmax)))
        ...
        plt.xticks(np.arange(0,len(rx)*nmax[0],len(rx))+(len(rx)/2),list(range(nmax[0])))
        plt.yticks(np.arange(0,len(ry)*nmax[1],len(ry))+(len(ry)/2),list(range(nmax[1])))
