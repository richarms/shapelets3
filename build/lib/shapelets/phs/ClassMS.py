...
class ClassMS():
    ...
    def GiveMappingAnt(self,ListStrSel, xxx_todo_changeme=(None,None),FlagAutoCorr=True):
    ...
    def SelChannel(self, xxx_todo_changeme1=(None,None,None),Revert=False):
        (start,end,step) = xxx_todo_changeme1
        if start!=None:
            if Revert==False:
